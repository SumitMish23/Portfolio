...
import IGF_SAAS from '../assets/IGF_SAAS.png';
const projectData = [{
  projectName: 'GraphLooker',
  projectInfo: 'Graphlooker is an open-source React-based web app designed to help users search and organize millions of web3 crypto data into well-structured tables.',
  imageSource: graphLookerImage,
  deploymentLink: 'https://graphlooker.com/'
}, {
  ...
  deploymentLink: 'https://dapplooker.com/'
}, {
  projectName: 'ImpactGuru Foundation',
  projectInfo: 'ImpactGuru Foundation is a crowdfunding-based NGO dedicated to raising funds for various causes.',
  imageSource: IGF,
  deploymentLink: 'https://www.impactgurufoundation.org/'
},
{
  projectName: 'IGF SAAS',
  projectInfo: 'IGF SAAS is a platform for enabling Rebel Foods employees to create accounts and automate charitable contributions to ImpactguruFoundation',
  imageSource: IGF_SAAS,
  deploymentLink: 'https://igfpayroll.impactgurufoundation.org/'
}, {
  projectName: "CrypBix",
  projectInfo:
